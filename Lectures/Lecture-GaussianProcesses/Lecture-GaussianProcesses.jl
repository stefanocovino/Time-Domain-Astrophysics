...
cm"- And, as usual, let's define a probabilistic model for our problem. We adopt uniform priors for simplicity. In a real preoblem choosing adequate prior would be a fundamental step for a properly carried out analysis."
...
- Nevertheles, we can check the poserior PDF of the parameters with a regular "corner plot":
"""
...
cm"- Not fully surprinsingly, the most probable values are not fuly consistent with the *true* values we used in generating our data."
...
- As a matter of fact, most of our discussion holds to multivariate datasets.
...
md"Notebook v1.0.0 - 10 April 2026"
...
manifest_format = "2.0"
project_hash = "a6b621001fa4c39935c31e5856d5af7dac66b132"
