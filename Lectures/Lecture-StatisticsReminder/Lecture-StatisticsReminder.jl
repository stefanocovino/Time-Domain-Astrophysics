...
# ╔═╡ 64932a9a-2084-4938-9030-66269702e472
WidthOverDocs()  

# ╔═╡ 81697eca-ebc6-436f-9638-b4f75f364508
TableOfContents()
...
md"""
Number of trials: $( @bind n1 NumberField(1:200, default=100) ) 
"""

# ╔═╡ b18909e0-205e-40ad-ab87-7985d986cb9d
md"""
Probability of success of a single trial: $( @bind p1 NumberField(0:0.01:1, default=0.166667) ) 
"""

# ╔═╡ 88012fd0-476a-46eb-9375-202ceccfc953
md"""
Number of successes: $( @bind x1 NumberField(1:n1, default=15) ) 
"""
...
# ╔═╡ 965712f3-af5a-48af-b345-5d023a1c85f4
md"- The probability of obtaining the required number or less (i.e. up to the required number) can also be easily computed."

# ╔═╡ be7d5b82-bb52-4b4d-84a4-784da6631b9f
totProbOfSuccesses1 = sum(pdf(binomialDistribution1,0:x1));

# ╔═╡ ab5fc6a5-dc0f-4c7b-8c36-b48d34384201
Markdown.parse("""
Probability of at least $x1 successes: $(latexify(100*totProbOfSuccesses1,fmt="%.2f"))%
""")
...
# ╔═╡ 22789239-3336-40c9-8920-69d75d983867
md"- The probability of having up to the required number of twin pregnancies can instead be computed as: "

# ╔═╡ 8000344d-1ed0-4541-bf11-86d69549da01
totProbOfSuccesses2 = sum(pdf(PoissonDistribution2,0:x2));

# ╔═╡ 780ec72c-b9a9-40f1-ba87-fbe8a70587d7
Markdown.parse("""
Probability of up to $x2 twin pregnancies: $(latexify(100*totProbOfSuccesses2,fmt="%.2f"))%
""")

# ╔═╡ 3f0e82d3-a3fb-49fa-8907-f39562375e62
md"- Let's see now a few plots about the Binomial and Poisson distributions:"
...
- Following the procedure we applied for the *mean* above we, finally, have: $\sigma^2 = n(n-1)p^2 + np - (np)^2 = -np^2 + np = np(1-p)$
...
# ╔═╡ 230e959d-643b-49ab-a0b2-00cd45d9161e
begin
...
manifest_format = "2.1"
project_hash = "d27cecba839b8d8959573a00c563eaa55979421e"
