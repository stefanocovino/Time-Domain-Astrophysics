...
# ╔═╡ 41daa43d-7234-4884-a50c-6e37e24852c2
WidthOverDocs() 

# ╔═╡ 7ee698e0-89bc-4d51-b8d8-405a3b67c441
TableOfContents()
...
- [David Fabricius](https://en.wikipedia.org/wiki/David_Fabricius) discovered “[omicron ceti](https://en.wikipedia.org/wiki/Mira)” in 1596:
    ...
    - It was re-observed in 1609 by Fabricius, and re-discovered in 1631 by [Johann Fokkens Holwarda](https://en.wikipedia.org/wiki/Johannes_Phocylides_Holwarda) who determined a 11 month period.
    - [Johannes Hevelius](https://en.wikipedia.org/wiki/Johannes_Hevelius) observed it in 1639 and 1642, and named the star “Mira” – The Wonderful.


- Earlier ancient discovery records unclear. [Hipparchus](https://en.wikipedia.org/wiki/Hipparchus) may have discovered Mira in 134 BC.
...
- [Geminiano Montanari](https://en.wikipedia.org/wiki/Geminiano_Montanari) discovered “[beta Persei](https://en.wikipedia.org/wiki/Algol)” in 1667:
    - Brightness varies from 2.1 to 3.4 magnitude in 2.87 days.
    - Period of less than 3 days credited to [John Goodricke](https://en.wikipedia.org/wiki/John_Goodricke) in 1782-83.
    - In 1881 [Edward Pickering](https://en.wikipedia.org/wiki/Edward_Charles_Pickering) theorized (correctly) that it was an eclipsing binary star system.
...
- In 1572 [Tycho Brahe](https://en.wikipedia.org/wiki/Tycho_Brahe) observed [SN 1572](https://en.wikipedia.org/wiki/SN_1572) and argued it was very far from Earth.
...
# ╔═╡ 7fd0833b-1099-44bb-823d-75c702079bbd
md"""
...
# ╔═╡ 0519ede6-824c-4011-aaa1-c753add7a0f8
Markdown.parse(
"""
Length of the monitoring: $(latexify((maximum(lnr[!,:t])-minimum(lnr[!,:t])) / 365,fmt="%.2f")) years.
"""	
)
...
Number of analyzed periods: $(length(lslnr.freq))
			   
Best period: $(latexify(best_period[1] * 24,fmt="%.2f")) hours
...
- Let's now move to data obtained by a survey carried out with a orbital instrument.
...
begin
	...
	arrows2d!([0.4,1.67], [0.62,0.62], [-0.25,0.25], [0.,0.]) 
...
# ╔═╡ c89f7651-861c-471d-8882-10ad3f218be3
Markdown.parse("""
			   
Mean sampling time: $(latexify(mspl,fmt="%.2f")) minutes			   
...
# ╔═╡ e3d718d2-f04b-4cab-a391-10976a175391
md"Notebook v1.1.1 - 18 September 2026"
...
manifest_format = "2.1"
project_hash = "d9cab7ddde5994f69edf09237fc1734ab44ae498"
