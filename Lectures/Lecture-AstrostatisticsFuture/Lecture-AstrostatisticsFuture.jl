...
# ╔═╡ 3d8286a8-5399-46ba-8c5b-05397fdd8fdf
WidthOverDocs()
...
$(LocalResource("Pics/lss.png"))


"""

# ╔═╡ d70cb43d-eafb-4d09-bf2e-5a1278fdb5cb
cm"""
...
$(LocalResource("Pics/photoz.png"))

"""

# ╔═╡ 08c82039-a3ae-4baa-9f37-5799cec985ca
cm"""
...
$(LocalResource("Pics/bayes.png"))

"""

# ╔═╡ 2700ac24-8cce-4c92-ae16-90ed2051e93d
cm"""
...
$(LocalResource("Pics/gw.png"))

"""

# ╔═╡ 1ab30197-e241-4ff8-b858-2ba1c9974e8d
cm"""
...
| $(LocalResource("Pics/blended.png")) | $(LocalResource("Pics/nn.png")) |
| ------------------------------------- | ------------------------------ |

"""

# ╔═╡ 9520fd25-805b-447e-8d91-9b3c30d38b4a
cm"""
...
# ╔═╡ a169a88e-48d8-4c21-a82e-bfe8f604ebe7
cm"""
...
# ╔═╡ aeb56ef7-70ea-4710-b883-e63c41919a64
cm"""

$(LocalResource("Pics/stars.png"))
...
# ╔═╡ c302e85c-cb9a-4324-bb00-619f102dc4de
cm"""
...
# ╔═╡ e34d8e98-9585-45c7-9869-82f5092c8a9d
md"Notebook v1.1.0 - 23 September 2026"
...
manifest_format = "2.1"
project_hash = "11ad13a413581e9663149e1759ce7d272ff0e38e"
