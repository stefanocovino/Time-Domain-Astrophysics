...
# ╔═╡ fd8e335b-ddb6-4afe-963a-0d29416ebd6a
WidthOverDocs()
...
begin
	...
	figcp = Figure(size = (700, 1200))
	
	nnf = 1
	for ensg in enumerate(zip(subjects, genders))
		    ssa_1, ssa_2 = subject_ssa[ensg[2][1]]
			...
			axcp = Axis(figcp[ensg[1], 1],
		        title = "Participant #$(ensg[2][1]) Walk 'Signature' ($(ensg[2][2]))",
		        xlabel = L"t \text{ (s)}",
		        ylabel = "Z-Score",
		        limits = (16, 20, -1.5, 1.5)
		    	)
		    
			lines!(axcp, time_index, sig1, color = :red, label = "Walk #1")
			lines!(axcp, time_index, sig2, color = :blue, label = "Walk #2")
...
manifest_format = "2.1"
project_hash = "0adcf04422af6415cf2552b9ab335267786af880"
